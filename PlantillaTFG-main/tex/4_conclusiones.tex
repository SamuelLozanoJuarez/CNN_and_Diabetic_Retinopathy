...
Pese a que ningún modelo rindió al nivel requerido, hay algunas combinaciones de arquitectura y conjuntos de datos que podrían llegar a superar las métricas establecidas si se continua ampliando el trabajo y se aplican algunas de las herramientas propuestas en el capítulo \hyperref[Fut]{Líneas de trabajo futuras}.
