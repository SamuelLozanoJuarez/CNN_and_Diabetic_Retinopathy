...
% Datos de portada
\title{Detección del grado de retinopatía diabética mediante redes convolucionales\\-\\Documentación Técnica}
\author{Samuel Lozano Juárez}
\tutor{Darío Fernández Zoppino}
\tutorb{Daniel Urda Muñoz}
\date{\today}
