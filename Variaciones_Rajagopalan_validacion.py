...
for capas in [3,5,7]:
    ...
    for n_filtros in [1.0,0.5,2.0]:
        ...
        for n_neuronas in ['512/256','1024/512','256/128','128/64','64/128','128/256']:
            ...
            inicio = time.time()
            #entrenamos la red con 7 épocas de paciencia en Early Stopping
            ...
            torch.save(modelo.state_dict(), f'modelos/Rajagopalan/OCT_Sival_Noprep_Noinp_RGB_{capas}_{filtros}_{neuronas}.pth')
