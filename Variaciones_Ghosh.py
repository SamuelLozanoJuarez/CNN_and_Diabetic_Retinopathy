...
A continuación se incluye el código que permite crear varios modelos según la arquitectura propuesta en el artículo de Ghosh, pero realizando las modificaciones
...
for capas in [6,9,13]:
    ...
    for n_filtros in [1.0,0.5,2.0]:
        ...
        for n_neuronas in ['256/1024/512','128/512/256','64/256/128','128/256/512','512/256/128']:
            ...
            guarda_graficas('OCT','No','No','No','RGB','Ghosh',capas,n_filtros,n_neuronas,acc,loss)
            ...
            torch.save(modelo.state_dict(), f'modelos/Ghosh/OCT_Noval_Noprep_Noinp_RGB_{capas}_{filtros_str}_{neuronas_str}.pth')
